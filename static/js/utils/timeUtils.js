...
TimeUtil.Time = class {
  ...
  static convertTimeStringToMilliseconds(time_string) {
    ...
    return TimeUtil.Time.hoursInMilliseconds(parseInt(hours)) + TimeUtil.Time.minutesInMilliseconds(parseInt(minutes)) + TimeUtil.Time.secondsInMilliseconds(parseInt(seconds));
  }
  ...
  getTimeInMillisecondsWithHoursOffset(hours) {
    return self.getTimeInMillisecondsWithOffsetMilliseconds(0) + TimeUtil.Time.hoursInMilliseconds(hours);
  }
};