...
class EventGroupsContainer extends React.Component {
  ...
  render() {
    ...
    if (this.state.search_query.length > 0) {
      ordered_groups = EventGroupsContainer.getGroupsFromSearch(events, this.state.search_query);
    } else {
    ...
    return React.createElement(EventGroupsView, {
...
function EventGroupsView(props) {
  return React.createElement(
    ...
    React.createElement(EventGroupsManipulationContainer, {
